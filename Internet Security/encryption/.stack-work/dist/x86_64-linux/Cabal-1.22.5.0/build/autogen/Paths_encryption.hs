...
getBinDir = catchIO (getEnv "encryption_bindir") (\_ -> return bindir)
getLibDir = catchIO (getEnv "encryption_libdir") (\_ -> return libdir)
getDataDir = catchIO (getEnv "encryption_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "encryption_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "encryption_sysconfdir") (\_ -> return sysconfdir)
